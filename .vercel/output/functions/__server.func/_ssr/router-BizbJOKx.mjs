...
const appCss = "/assets/styles-Bq7Sq7oK.css";
...
const Route = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "CRM político offline-first com IA, geo-inteligência e automação de WhatsApp. Transforme trabalho de campo em estratégia vencedora."
    }, {
      property: "og:title",
      content: "ATLAS — Uma Nova Forma de Fazer Política"
    }, {
      property: "og:description",
      content: "Plataforma de gestão eleitoral com captura offline, dashboards em tempo real, IA de campanha e automação WhatsApp."
    }, {
      property: "og:type",
      content: "website"
    }, {
